...
// Activity: Create an alert box that welcomes the user
    let alertMessage = "This is my first text in a varibale";
    alert(alertMessage);
...
// Activity: Concatenate two strings and log the result to the console
    ...
    let str2 = " the date is February 17th, 2025";

    console.log(str2 + ". I love Mondays!" + str1);
// 3. Template Literals
// Activity: Use template literals to create a sentence with variables
    let firstName = 'Lexius';
    let lastName = 'Waltar';
    let goodNightMessage = `Good evening, ${firstName} ${lastName}. Have a nice night!`
    console.log(message);
...
// Activity: Experiment with different string methods like .length, .toUpperCase(), .trim(), etc.
    ...
    console.log(message.trim()); //Javascript is awesome!
    console.log(message.includes("awesome")); //true
    console.log(message.slice(0,-5)); //  Jav
